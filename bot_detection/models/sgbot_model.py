...
def train_and_test_rf(features, labels, train_idx, val_idx, test_idx, instance_name):
    ...
    # Early stopping on validation set (optional, simple implementation: stop if F1 does not improve, or just use all rounds)
    # Here, we just do simple training
...
results_path = "../results/sgbot_test_results.csv"
results = []
...
for instance_name in instance_names:
    ...
    train_and_test_rf(features, labels, train_idx, val_idx, test_idx, instance_name)
